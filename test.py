...
attr = []
value = []
for n in range(len(title))[:-4]:
    # print(title[n]['href'],title[n].text)
    attr.append(title[n].text)
    value.append(1)
...
geo = Geo("全国主要城市空气质量", "data from pm2.5", title_color="#fff", title_pos="center", width=1000,height=600, background_color='#404a59')
# attr, value = geo.cast(data)
print(attr)
print(value)
geo = Geo("全国主要城市空气质量", title_color="#fff", title_pos="center", width=1000,height=600, background_color='#404a59')
geo.add("", attr, value, visual_range=[0, 200],visual_text_color="#fff",symbol_size=10, is_visualmap=True)
geo.render()#生成html文件
